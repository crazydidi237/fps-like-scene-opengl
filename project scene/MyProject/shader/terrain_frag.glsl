...
vec4 GenerateTerrainColor()
{
    ...
    terrainColor += regionWeight* texture(region1ColorMap, uv_image);
    ...
    regionWeight = (regionRange - abs(height - regionMax)) / regionRange;
    regionWeight = max(0.0, regionWeight);
    terrainColor += regionWeight * texture(region2ColorMap, uv_image);
    ...
    regionWeight = (regionRange - abs(height - regionMax)) / regionRange;
    regionWeight = max(0.0, regionWeight);
    terrainColor += regionWeight * texture(region3ColorMap, uv_image);
